...
class Collect extends AbstractApiAction implements CollectInterface
{
    ...
    public function pull($withData)
    {
        ...
        $authorizedModels=['deleted_customer','deleted_product','product','visit','customer','country','order','quote','category','priceRule','catalogRule','coupon','deleted_priceRule','deleted_catalogRule','customerGroup','popupCustomer','customers_guest','wishlist'];
